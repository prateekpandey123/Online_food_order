...
<html>
	...
	<body>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
			...
			<a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">Food Plaza</span></a>
			<?php
				if(!empty($cust_id))
				{
			?>
				...
				<li class="nav-item">
					<form method="post">
						<?php
							...
							{
						?>
						<a href="form/index.php?msg=you must be login first"><span style="color:red; font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:red;" id="cart"  class="badge badge-light">0</span></i></span>
						</a>
	...
	<div id="demo" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="img/slidermain.jpg" alt="Los Angeles" class="d-block w-100">
				<div class="carousel-caption">
					<h3>Restruent</h3>
					<p>We had such a great time in RESTRUENT!</p>
				</div>
			</div>
			...
			<div class="carousel-item">
				<img src="img/slidermain2.jpg" alt="New York" class="d-block w-100">
				<div class="carousel-caption">
					<h3>Pune</h3>
					<p>We love the Pasta!</p>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<div class="container">
					<p style="font-family: 'Lobster', cursive; font-weight:light;  font-size:25px;">Cauliflower sabzi is the most common vegetable dish found in everyday cooking and this phool gobi sabzi is made with simple spices and quick in making.
					I have also shared another gobi recipe that is cauliflower fry  and aloo gobhi ki sabji which is also a common side dish usually made. Roti sabji I've eaten this (or something very similar) for breakfast almost every single day of my travels through India and Nepal! Roti is a simple wheat-based flatbread eaten all throughout Northern India and Nepal. Sabji is vegetable curry, and more often than not includes potatoes. Sometimes served with silverware, but usually this dish is eaten by tearing and dipping the roti into the sabji, using only the utensils at the end of your arms (as most meals here are usually consumed!) </p>
				</div>
...
<div class="container">
	<!--paragraph content-->
	<p style="font-family: 'Lobster', cursive; font-weight:light; font-size:25px;">If you love pasta, and if you love Indian food, you won’t be able to resist this Masala Pasta. A fiery red tomato sauce seasoned with cumin and garlic and mellowed with cashew cream makes every bite one to remember. A vegan, soy-free recipe, can be nut-free Indo-Italian fusion food may be a newer concept than Indo-Chinese, but it’s arrived and it’s here to stay, with recipes like this Masala Pasta which has become popular, in all its fiery glory, on the streets of cities like New Delhi and Bombay.</p>
</div>
</div>
