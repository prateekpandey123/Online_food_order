  ...
  <div class="row">
    <div class="col-sm-8" style="padding:20px; border:1px solid #F0F0F0;">
	    <form method="post">
			...
			<div class="form-group">
                 <input type="email" class="form-control"  placeholder="Enter Email*" value="<?php if(isset($cust_id)) echo $cust_id; ?>" name="email" required/>
            </div>
			<div class="form-group">
                 <input type="tel" class="form-control" pattern="[6-9]{1}[0-9]{9}"  name="phone" placeholder="Enter Mobile"/>
            </div>
			<div class="form-group">
                <textarea class="form-control"    placeholder="Write Message*" name="msgtxt" rows="3" col="10" required/></textarea/>
            </div>
			<div class="form-group">
    ...
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
           <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>+91-8687767493</b><br><br>
			<i class="fa fa-home" aria-hidden="true"></i>&nbsp; Sant TukaRam Nagar,Pimpri, Near YCM Hospital, Pune, 411018,<br>Service's (24*7 Days)
